      ...
      <div className="flex gap-3 overflow-x-auto pb-1 -mx-1 px-1">
        {playlists.map((p) => (
          <button
            ...
            className="shrink-0 w-[132px] text-left"
          >
            <div
              className="relative w-[132px] h-[132px] rounded-thumb overflow-hidden"
            ...
            <div className="mt-1.5 font-heading font-bold text-[12.5px] text-text-primary line-clamp-2">
              {p.name}
            </div>
          </button>
        ))}
